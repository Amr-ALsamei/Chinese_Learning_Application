...
class VocabulariesTestingLevels extends GetView<VocabulariesTesController> {
  const VocabulariesTestingLevels({super.key});
        ...
        return level % 3 == 0
                      ...
                      child: InkWell(
                        onTap: () {
                          if (controller.myServices.sharedPref.getDouble(
                                  "VocabularyQusionlevel${level - 1}") ==
                              (level - 1) * 10) {
                            if (controller.myServices.sharedPref
                                    .getDouble("VocabularyQusionlevel$level")! <
                                (level * 10)) {
                              int h = controller.myServices.sharedPref
                                          .getDouble(
                                              "VocabularyQusionlevel$level")!
                                          .toInt() ==
                                      0
            ...
            : Container(
                ...
                child: InkWell(
                  onTap: () {
                    if (controller.myServices.sharedPref
                            .getDouble("VocabularyQusionlevel${level - 1}") ==
                        (level - 1) * 10) {
                      if (controller.myServices.sharedPref
                              .getDouble("VocabularyQusionlevel$level")! <
                          (level * 10)) {

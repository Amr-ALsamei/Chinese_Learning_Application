...
LettersTesController controller = Get.find();
void LetterTrueAnswerBottomSheet() {
  Get.bottomSheet(
    ...
    Container(
      ...
      child: GetBuilder<LettersTesController>(builder: (controller) {
          ...
          ElevatedButton(
              ...
              onPressed: () {
                ...
                if (i < controller.data.length) {
                  ...
                  controller.translationFun(controller.data[i].letterBody);
...
void LetterFalseAnswerBottomSheet() {
  Get.bottomSheet(
    backgroundColor: const Color.fromARGB(255, 243, 235, 235),
    isDismissible: false,
    enableDrag: false,
